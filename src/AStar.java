...
public class AStar {
    ...
    public static void search(State initialState){
        ...
        PriorityQueue<State> frontier = new PriorityQueue<>(new AStarStateComparator());
...
class AStarStateComparator implements Comparator<State> {

    @Override
    public int compare(State o1, State o2) {
        //if o1 is more optimistic       -> it should be polled out of frontier faster
        // -> it should have lower value -> o1 < o2

        //so if o1 is more optimistic than o2 --> o1<o2 --> return -1

        //o1 is more optimistic == has lower g(n) + h(n) == o1 < o2
    ...
    public static int eval(State state) {
        return heuristic(state)+state.depth;
    }
